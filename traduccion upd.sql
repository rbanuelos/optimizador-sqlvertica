...
update STAGING.FCT_TRAFICO_GPRS_PENDIENTE a
set /*APN_ID = a.apn_id ,
FECHA_AUX =   ,
PLAN_GPRS_ID    ,
PLAN_TARIFARIO_GPRS_ID  ,
CLASE_CREDITO_GPRS_ID   ,
TIPO_DESCUENTO_ID   ,
MONTO_CREDITO_DESCONTADO    ,
MONTO_TASADO    ,
KB_DESCONTADO   ,
KB_COBRADO  ,
KB_TASADO   ,
...
/*FECHA_KEY   ,
HORA_KEY    ,*/
PLAN_LLAMADA_KEY  = LC.PLAN_LLAMADA_ACT_KEY  ,
PLAN_TARIFARIO_LLAMADA_KEY = LC.PLAN_TARIFARIO_LLAMADA_ACT_KEY ,
CLASE_CREDITO_LLAMADA_KEY = LC.CLASE_CREDITO_LLAMADA_ACT_KEY  ,
PLAN_MENSAJE_KEY  = LC.PLAN_MENSAJE_ACT_KEY  ,
PLAN_TARIFARIO_MENSAJE_KEY =  LC.PLAN_TARIFARIO_MENSAJE_ACT_KEY,
CLASE_CREDITO_MENSAJE_KEY  =  LC.CLASE_CREDITO_MENSAJE_ACT_KEY ,
PLAN_GPRS_KEY  = (CASE
                  ...
                  ELSE
                     a.PLAN_GPRS_KEY
               END) ,
PLAN_TARIFARIO_GPRS_KEY =  LC.PLAN_TARIFARIO_GPRS_KEY,
CLASE_CREDITO_GPRS_KEY = (CASE
...
TIPO_DESCUENTO_KEY = (CASE
               ...
               END) ,
TECNOLOGIA_KEY  = LC.TECNOLOGIA_ACT_KEY,
LOCALIDAD_KEY  =  LC.LOCALIDAD_TITULAR_KEY,
ESTADO_LINEA_KEY   = LC.ESTADO_LINEA_ACT_KEY ,
/*CANTIDAD_VECES  ,
INSERTADO   ,
MB_DESCONTADO   ,
MB_COBRADO  ,
...
CELDA_KEY  = (CASE
                  ...
                  ELSE
                     a.CELDA_KEY
               END) ,
TIPO_PERSONA_KEY  = LC.TIPO_CLIENTE_KEY  ,
TIPO_SOCIEDAD_KEY = LC.TIPO_SOCIEDAD_KEY  ,
CODIGO_CLIENTE = TO_NUMBER(LC.cliente_titular) ,
CHARGING_ID ,
ES_ROAMING_ID  ,
OPERADORA_ROAMING_ID    ,
ES_ROAMING_KEY = (CASE
...
TECNOLOGIA_ACCESO_KEY = (CASE
                           ...
                           END)  ,
TECNOLOGIA_ACCESO_ID    ,
CANTIDAD_SERVICIOS  ,
FECHA_TASACION  ,
RECORD_SEQUENCE_NUMBER  ,
LOCAL_RECORD_SEQUENCE_NUMBER    ,
MTO_IVA ,
MTO_TOTAL   ,
NODE_ID ,
FRACCIONAMIENTO ,
RATING_GROUP    ,
RATING_GROUP_KEY  = (CASE
...
COD_TAR_GPRS_KEY  = (CASE
                          ...
                          ELSE
                             a.cod_tar_gprs_key
                       END)  ,
CELDA_X_ZONA_KEY  =  LC.CELDA_X_ZONA_KEY  ,
TRAFICO_PACK    ,
CANTIDAD    ,
SERVICIO_TASABLE_ID ,
DESCUENTO_ID    ,
SERVICIO_COMERCIAL_ID   ,
SERVICIO_PACK_ID    ,
PAQUETE_SERVICIO_ID ,
SERVICIO_TASABLE_KEY  = (CASE
...
DESCUENTO_KEY = (CASE
                     ...
                     THEN
                      ...
                      ELSE
                         a.DESCUENTO_KEY
                   END)  ,
CANTIDAD_SERV_APLICADOS_KEY = (CASE
                               ...
                               END) ,
APLICA_SERVICIOS_KEY  =  ,
SERVICIO_COMERCIAL_KEY = (CASE
                            ...
                            END) ,
SERVICIO_PACK_KEY   ,
PAQUETE_SERVICIO_KEY    ,
DESCONTADO_DATOS    ,
DESCONTADO_CREDITO  ,
GS_ABONO_CARGA  ,
USD_ABONO_CARGA ,
EXCEDENTE_CREDITO_USD   ,
MONTO_DATOS_DESC    ,
TIPO_CREDITO_DESCONTADO_KEY ,
TRAFICO_SIN_COSTO   ,
TRAFICO_CON_COSTO   ,
GPRS_CON_COSTO_KEY  ,
MARCA_VIP_KEY   ,
SEGMENTO_LINEA_KEY  ,
SEGMENTO_CLIENTE_KEY    ,
CARACTERISTICA_ABONADO_ID   ,
MANEJO_CONTINUIDAD_FALLO_ID ,
CARACTERISTICA_ABONADO_KEY  ,
MANEJO_CONTINUIDAD_FALLO_KEY    ,
CANTIDAD_HILO   ,
SEGMENTO_INTERNET_KEY   ,
EST_PORT_KEY    
